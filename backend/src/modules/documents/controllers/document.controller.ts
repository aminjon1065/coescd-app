...
export class DocumentController {
  ...
  create(@Body() dto: CreateDocumentDto, @ActiveUser() user: ActiveUserData) {
    return this.documentsFacade.legacy.create(dto, user);
  }
  ...
  findAll(
    ...
    return this.documentsFacade.legacy.findAll(user, query);
  }
  ...
  findOne(@Param('id') id: string, @ActiveUser() user: ActiveUserData) {
    return this.documentsFacade.legacy.findOne(+id, user);
  }
  ...
  findDocumentFiles(
    ...
    return this.documentsFacade.legacy.findDocumentFiles(id, user);
  }
  ...
  linkFile(
    ...
    return this.documentsFacade.legacy.linkFile(
      id,
      fileId,
      user,
  ...
  unlinkFile(
    ...
    return this.documentsFacade.legacy.unlinkFile(
      id,
      fileId,
      user,
      getRequestMeta(request),
  ...
  update(
    ...
    return this.documentsFacade.legacy.update(+id, dto, user);
  }
  ...
  remove(@Param('id') id: string, @ActiveUser() user: ActiveUserData) {
    return this.documentsFacade.legacy.remove(+id, user);
  }
}
