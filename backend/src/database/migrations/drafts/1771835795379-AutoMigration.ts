...
export class AutoMigration1771835795379 implements MigrationInterface {
    name = 'AutoMigration1771835795379'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "calls" DROP CONSTRAINT "FK_CALLS_RECEIVER"`);
        await queryRunner.query(`ALTER TABLE "calls" DROP CONSTRAINT "FK_CALLS_INITIATOR"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_CHAT_MESSAGES_ROOM_CREATED"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_CHAT_MESSAGES_SENDER"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_CALLS_INITIATOR"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_CALLS_RECEIVER"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_CALLS_STATUS"`);
        ...
        await queryRunner.query(`CREATE TABLE "file_shares" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "file_id" integer, "shared_with_user_id" integer, "shared_with_department_id" integer, "granted_by_id" integer, CONSTRAINT "PK_2f3e107e30c8ad1012907a4346b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "file_shares" ADD CONSTRAINT "FK_8ad4e87c25a7c2c0e1b474a500e" FOREIGN KEY ("file_id") REFERENCES "files"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "file_shares" ADD CONSTRAINT "FK_b65bd883b161ba26c884f179927" FOREIGN KEY ("shared_with_user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "file_shares" ADD CONSTRAINT "FK_8dc3aee29a91a97ec00fe6af261" FOREIGN KEY ("shared_with_department_id") REFERENCES "departments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "file_shares" ADD CONSTRAINT "FK_c6349c72c62bf7409dab7487a48" FOREIGN KEY ("granted_by_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "file_links" DROP CONSTRAINT "FK_c78a61293671a996c88094cc56f"`);
        await queryRunner.query(`ALTER TABLE "file_links" DROP CONSTRAINT "FK_64db2f1947f0f95e79d8659207f"`);
        await queryRunner.query(`ALTER TABLE "file_shares" DROP CONSTRAINT "FK_c6349c72c62bf7409dab7487a48"`);
        await queryRunner.query(`ALTER TABLE "file_shares" DROP CONSTRAINT "FK_8dc3aee29a91a97ec00fe6af261"`);
        await queryRunner.query(`ALTER TABLE "file_shares" DROP CONSTRAINT "FK_b65bd883b161ba26c884f179927"`);
        await queryRunner.query(`ALTER TABLE "file_shares" DROP CONSTRAINT "FK_8ad4e87c25a7c2c0e1b474a500e"`);
        await queryRunner.query(`ALTER TABLE "files" DROP CONSTRAINT "FK_fe49ddbcf2436d7a6fbbbc71293"`);
        await queryRunner.query(`ALTER TABLE "files" DROP CONSTRAINT "FK_4bc1db1f4f34ec9415acd88afdb"`);
        await queryRunner.query(`ALTER TABLE "tasks" DROP CONSTRAINT "FK_ed83132cc853103ac2acd948992"`);
        await queryRunner.query(`ALTER TABLE "tasks" DROP CONSTRAINT "FK_f4cb489461bc751498a28852356"`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_CALLS_RECEIVER" ON "calls" ("created_at", "receiver_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_CALLS_INITIATOR" ON "calls" ("created_at", "initiator_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_CHAT_MESSAGES_SENDER" ON "chat_messages" ("sender_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_CHAT_MESSAGES_ROOM_CREATED" ON "chat_messages" ("created_at", "room") `);
        ...
        await queryRunner.query(`ALTER TABLE "calls" ADD CONSTRAINT "FK_CALLS_INITIATOR" FOREIGN KEY ("initiator_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "calls" ADD CONSTRAINT "FK_CALLS_RECEIVER" FOREIGN KEY ("receiver_id") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
